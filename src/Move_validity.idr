...
is_valid_move_stage_1 m (Running b _ _ _) = case m of
  ...
  Double_capture p1 c1 p2 c2 p3 c3 => case is_same_piece_at p1 c1 b of
   False => (False, "Selected piece is not piece on starting square")
   True => case (piece_colour p1) == (piece_colour p2) of
     True  => (False, "Can't capture piece of same colour")
     False => case is_lion (piece_type p1) of                           
       True  => is_valid_lion_double_move_stage_1 c1 p2 c2 (Just p3) c3 
       False => case piece_type p1 of
         Soaring_eagle => is_valid_soaring_eagle_double_move_stage_1 c1 p2 c2 (Just p3) c3
         Horned_falcon => is_valid_horned_falcon_double_move_stage_1 c1 p2 c2 (Just p3) c3
         _             => (False, "That type of piece may not make double moves")
  Capture_and_move p1 c1 p2 c2 c3 => case is_same_piece_at p1 c1 b of
   False => (False, "Selected piece is not piece on starting square")
   True => case (piece_colour p1) == (piece_colour p2) of
     True  => (False, "Can't capture piece of same colour")
     False => case is_lion (piece_type p1) of                           
       True  => is_valid_lion_double_move_stage_1 c1 p2 c2 Nothing c3 
       False => case piece_type p1 of
         Soaring_eagle => is_valid_soaring_eagle_double_move_stage_1 c1 p2 c2 Nothing c3
         Horned_falcon => is_valid_horned_falcon_double_move_stage_1 c1 p2 c2 Nothing c3
         _             => (False, "That type of piece may not make double moves")
...
is_valid_move_stage_2 m st = case is_valid_move_stage_1 m st of
  ...
  _          => case st of
    ...
    Running b mv_st _ stk =>  case m of
      Double_capture p1 c1 p2 c2 p3 c3 => case is_lion (piece_type p1) of
      ...
      Capture_and_move p1 c1 p2 c2 c3 => case is_lion (piece_type p1) of
        ...
        True  => (True, "") -- single capture on first square
